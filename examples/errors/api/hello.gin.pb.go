...
func (*UnimplementedGreeterHTTPServer) TestError(context.Context, *ErrorRequest, *ErrorReply) error {
	return errors.New("method TestError not implemented")
}
...
func _Greeter_TestError0_HTTP_Handler(srv GreeterHTTPServer) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		err := srv.TestError(c.Request.Context(), &req, &rsp)
		if err != nil {
			srv.ErrorEncoder(c, err, false)
			return
		}
